...
const Data =  [
        ...
        extraText: `• איך מגישים את הבקשה? יש להגיש תלושי שכר של 3 חודשים טרם האשפוז, את התשלום ניתן לקבל לחשבון הבנק של המלווה / לחשבון המעסיק ע"מ לשמור על תלושי השכר תקינים.
                ...
                <br>• מלווים: 
                        <br>  o הגדרת המלווה: המלווה יכול להיות כל אדם הנמצא ליד הפצוע המעגל הקרוב, עדיפות לאישה / הורים / בן -בת זוג / אחים / דוד, ניתן לבקש על חבר באופן חריג. 
                        <br>  o כמות המלווים:
        ...
        המקדמה בסך 3,000 ש"ח תועבר לחשבון המשפחה בתחילת כל חודש אשפוז כל עוד הפצוע מאושפז (חודש אשפוז ולא חודש קלנדרי, ביום האשפוז ה - 1, 31, 61 וכו).
        במידה ויושלם חודש אשפוז המשפחה תקבל את ההפרש וההשלמה ל 11,570 ₪ (חודש אשפוז ולא חודש קלנדרי, ביום האשפוז ה - 30, 60, 90 וכו).
        <b>במידה והפצוע לא השלים חודש אישפוז ישולם סכום המענק לפי 380 ש"ח ליום אשפוז בניכוי המקדמה.</b>
        פצוע ששוחרר לאחר מס' ימים לא ידרש להחזיר את המקדמה.`,
        extraText: `• משפחה גרעינית: אישה / הורים.
        <br>o במידה ונשוי, אישה קודמת להורים.
        <br>o ניתן לחלק את המענק שווה בשווה, בין האישה וההורים באישור הפצוע.
        <br>o במידה וההורים גרושים, ניתן לחלק בניהם את המענק.
        <br>o במידה והורים גרושים אך הפצוע אינו בקשר עם אחד ההורים, יש להוסיף מכתב המסביר זאת.
        <br>o במידה והפצוע מורדם, האישה קובעת האם לחלק את המענק.
        <br>o במידה והפצוע חייל בודד, שאינו בקשר עם משפחתו / משפחתו אינה שוהה בארץ, ניתן לבקש שהמענק יועבר לאדם אחר הנמצא עימו באשפוז, יש להוסיף מכתב המסביר זאת.`},
        {id: 5, type: 1, name: `הוצאות נסיעה וכלכלה חודשיות`,
        text: `מענק חודשי ע"ס 11,570 ש"ח שישולם לחשבון המשפחה הגרעינית בשתי פעימות - מקדמה והמשך המענק בתום האשפוז / בתום 30 ימי אשפוז.
        המקדמה בסך 6,000 ש"ח תועבר לחשבון המשפחה בתחילת כל חודש אשפוז כל עוד הפצוע מאושפז (חודש אשפוז ולא חודש קלנדרי, ביום האשפוז ה - 1, 31, 61 וכו).
        במידה ויושלם חודש אשפוז המשפחה תקבל את ההפרש וההשלמה ל 11,570 ₪ (חודש אשפוז ולא חודש קלנדרי, ביום האשפוז ה - 30, 60, 90 וכו).
        <b>במידה והפצוע לא השלים חודש אישפוז ישולם סכום המענק לפי 380 ש"ח ליום אשפוז בניכוי המקדמה.</b>
        פצוע ששוחרר לאחר מס' ימים לא ידרש להחזיר את המקדמה.`,
        extraText: `• משפחה גרעינית: אישה / הורים.
